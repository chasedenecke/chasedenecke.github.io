...
<div id="wrapper"> 
  <p align="center">
    <video id="home1" autoplay muted loop="loop" controls width="370" height="370">
      <source src="assets/videos/prune-still_ppo-min.mp4" type="video/mp4">
    </video>
    <video id="home2" autoplay muted loop="loop" controls width="370" height="370">
...
<p align="center">
<video autoplay muted loop="loop" controls width="832" height="468">
